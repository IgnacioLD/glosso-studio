...
interface SpeechController {
    ...
    fun playAudio(base64: String, speed: Float = 1.0f, onComplete: (() -> Unit)? = null)
    fun playNormalized(base64: String, onComplete: (() -> Unit)? = null)
    fun playWordSlice(fullBase64Wav: String, startSec: Float, endSec: Float, onComplete: (() -> Unit)? = null)
